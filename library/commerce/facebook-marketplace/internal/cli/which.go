...
var whichIndex = []whichEntry{
	...
	{Command: "matches", Description: "Show new watch matches after deterministic filtering and one LLM relevance pass on survivors.", Group: "Buy-side workflow", WhyItMatters: "Use this when an agent needs the shortlist worth showing a human buyer."},

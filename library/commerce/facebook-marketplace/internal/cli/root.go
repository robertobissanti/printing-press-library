...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Search, mirror, and manage Facebook Marketplace workflows from a local, read-mostly CLI.`,
		Long: `Search, mirror, and manage Facebook Marketplace workflows from a local, read-mostly CLI.
